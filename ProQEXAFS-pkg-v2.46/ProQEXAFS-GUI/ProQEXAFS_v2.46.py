...
################################################################################		
	def split(self):
		...
		sub_f = 'main-pkg/proxas/batch_split_subroutine_v2.4.py'
...
################################################################################	
	def batch_export(self):
		...
		if proceed_var == True:
			...
			sub_f = 'main-pkg/proxas/batch_extract_subroutine_v2.9.5.py'
