...
################################################################################
#Matrix Cut		
		self.CutFrame = tkinter.LabelFrame(master=f1, width=300, height=0.75*self.screen_height, pady=5, padx=65)
		self.CutFrame.grid(row=3, column=0) 
		
		cutuselabel = tkinter.Label(self.CutFrame, text='Cut Output Matrix',anchor='w')
...
################################################################################
		...
		self.PadFrame = tkinter.LabelFrame(master=f2, width=300, height=0.75*self.screen_height, pady=380, padx=166)
